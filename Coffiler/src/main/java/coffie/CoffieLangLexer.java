...
public class CoffieLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DOT", "ASSIGN", "PLUS", "MINUS", "STAR", "DIV", "MOD", "LT", "GT", "LE", 
			"GE", "EQ", "NEQ", "AND_AND", "OR_OR", "NOT", "IntegerLiteral", "FloatLiteral", 
			"BooleanLiteral", "StringLiteral", "Identifier", "LINE_COMMENT", "BLOCK_COMMENT", 
			"WS"
		};
	}
