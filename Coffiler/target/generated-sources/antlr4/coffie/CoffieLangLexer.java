...
public class CoffieLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PUBLIC", "CLASS", "STATIC", "VOID", "MAIN", "NEW", "IF", "ELSE", "WHILE", 
			"FOR", "RETURN", "SYSTEM_OUT_PRINTLN", "TYPE_INT", "TYPE_DOUBLE", "TYPE_BOOLEAN", 
			"TYPE_STRING", "TYPE_VOID", "PLUS", "MINUS", "MULT", "DIV", "MOD", "ASSIGN", 
			"EQ", "NEQ", "LT", "GT", "LE", "GE", "DOT", "COMMA", "SEMI", "LP", "RP", 
			"LB", "RB", "LB_ARR", "RB_ARR", "BOOL_LITERAL", "INT_LITERAL", "FLOAT_LITERAL", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"FLOAT_LITERAL", "STRING_LITERAL", "ID", "COMMENT", "WS"
		};
	}
